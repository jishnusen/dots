...
hi Search gui=underline guibg=#f0f0f0 guifg=#000000 cterm=underline ctermbg=7 ctermfg=3
hi IncSearch gui=underline guibg=#505050 guifg=#ffffff term=none cterm=underline ctermbg=8 ctermfg=15
...
hi MatchParen gui=underline guibg=#f0f0f0 guifg=#505050 cterm=underline ctermbg=7 ctermfg=8

hi ToolbarLine guibg=#505050 guifg=#ffffff term=none ctermbg=8 ctermfg=15
hi ToolbarButton gui=none guibg=#505050 guifg=#ffffff term=none cterm=none ctermbg=8 ctermfg=15
...
hi Character gui=none guifg=#005a5f cterm=none ctermfg=14

hi Type gui=none guifg=#00538b term=none cterm=none ctermfg=6
hi StorageClass guifg=#00538b ctermfg=6
hi Structure guifg=#00538b ctermfg=6
hi Typedef gui=none guifg=#005a5f cterm=none ctermfg=14

hi Conditional gui=none guifg=#5317ac cterm=none ctermfg=13
hi Statement gui=none guifg=#5317ac cterm=none ctermfg=13
hi Repeat gui=none guifg=#8f0075 cterm=none ctermfg=5
hi Operator gui=none guifg=#000000 cterm=none ctermfg=0
hi Exception gui=none guifg=#813e00 cterm=none ctermfg=2

hi Preproc gui=none guifg=#972500 term=none cterm=none ctermfg=9
hi PreCondit gui=none guifg=#972500 cterm=none ctermfg=9
hi Macro gui=none guifg=#8f0075 cterm=none ctermfg=5
hi Include guifg=#972500 ctermfg=9
hi Define guifg=#972500 ctermfg=9

hi Title gui=none guibg=#ffffff guifg=#00538b cterm=none ctermbg=15 ctermfg=6

hi Delimiter gui=none guifg=#000000 cterm=none ctermfg=0
hi SpecialComment gui=none guifg=#863927 cterm=none ctermfg=3
...
hi CursorLineNr gui=none guibg=#505050 guifg=#ffffff cterm=none ctermbg=8 ctermfg=15
...
hi SpecialChar gui=none guifg=#70480f cterm=none ctermfg=11
hi NonText gui=none guibg=#f0f0f0 guifg=#505050 cterm=none ctermbg=7 ctermfg=8
hi EndOfBuffer gui=none guifg=#505050 cterm=none ctermfg=8

hi Directory gui=none guifg=#005e00 term=none cterm=none ctermfg=2
hi Question gui=none guifg=#70480f cterm=none ctermfg=11
hi MoreMsg guifg=#315b00 ctermfg=10
hi ModeMsg gui=none guifg=#005e00 cterm=none ctermfg=2
...
hi PmenuSel gui=none guibg=#505050 guifg=#ffffff cterm=none ctermbg=8 ctermfg=15
...
" Diffs
" -----
hi DiffAdd gui=none guibg=#005e00 guifg=#ffffff cterm=none ctermbg=10 ctermfg=15
hi DiffDelete gui=none guibg=#a60000 guifg=#ffffff cterm=none ctermbg=9 ctermfg=15
hi DiffChange gui=none guibg=#f0f0f0 guifg=#505050 cterm=none ctermbg=7 ctermfg=8
hi DiffText gui=none guibg=#f0f0f0 guifg=#972500 cterm=none ctermbg=7 ctermfg=1
...
hi GitGutterChange gui=none guibg=#f0f0f0 guifg=#505050 cterm=none ctermbg=7 ctermfg=8
hi GitGutterDelete guibg=#f0f0f0 guifg=#a60000 ctermbg=7 ctermfg=1
hi GitGutterChangeDelete gui=none guibg=#f0f0f0 guifg=#a60000 cterm=none ctermbg=7 ctermfg=1
...
" Markdown
" --------
hi MarkdownRule gui=none guibg=#f0f0f0 guifg=#315b00 cterm=none ctermbg=7 ctermfg=10

hi MarkdownHeading gui=none guifg=#000000 cterm=none ctermfg=0
...
hi MarkdownBold gui=none guifg=#972500 cterm=none ctermfg=9
...
hi MarkdownLinkDelimiter gui=none guifg=#000000 cterm=none ctermfg=0
